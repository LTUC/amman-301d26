...
const sumUsingArrow = (a,b,c,d) =>  a + b + c + d;

console.log(sumUsingArrow(1,2,3,4));
...
const objectLitUsingArrow = () => ({
	key1: 'value1',
    key2: 'value2',
    key3: 'value3',
})
console.log(objectLitUsingArrow());
...
let sumAndProductUsingArrow = (a,b) =>{
	let sum = a + b;
  let product = a * b;
  return [sum, product];
}
console.log(sumAndProductUsingArrow(3,9));
...
let messageUsingArrow = (name) => `Hello, ${name}!`;
console.log(messageUsingArrow('Allie'));
...
console.log(joe);
// can't apply arrow function in constructor function!
...
// it relates to the global object and will have undefined 
