...
// TODO: Uncomment the following line of code to see the output in the browser console
 ...
 let newObjectList = () => ({ key1: 'value1', key2: 'value2', key3: 'value3',});
...
let newMsg = (name) => `Hello, ${name}!`;

console.log(newMsg('Allie'));
...
// let joe2 = new Student2('Joe2', 'Schmoe', 100); // Arrow functions cannot be used as constructors and will throw an error
// console.log(joe2);
