...
export class MyCats extends Component {
  ...
  /**
   * Execute whatever is within the componentDidMount when the component loaded
   */
  componentDidMount = () => {
  ...
  /**
   * display Modal function that updates the state to display the Add cat formModal
   */
  handelDisplayModal = () => {
  ...
  /**
   * display Modal function that updates the state to display the update cat formModal
   */
